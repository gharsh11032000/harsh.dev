...
const Services: React.FC = () => {
  return (
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 min-w-0 w-full">
        {services.map((service) => (
          <div
            key={service.id}
            className="glass group relative rounded-xl sm:rounded-2xl border border-white/10 hover:border-yellow-500/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_40px_-10px_rgba(234,179,8,0.2)] min-w-0"
          ...
          >
            ...
            <div className="mb-4 sm:mb-6 bg-black w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center border border-neutral-800 text-gray-400 group-hover:text-yellow-500 group-hover:border-yellow-500/50 transition-all shadow-inner shrink-0">
              {service.icon}
            </div>
            ...
            <p
              className="text-gray-400 leading-relaxed font-medium wrap-break-word min-w-0"
