  ...
  return (
    ...
    >
      <div className="container relative z-10">
        {(title || subtitle) && (
          <div className="mb-8 sm:mb-12 md:mb-16 text-center max-w-[min(48rem,100%)] mx-auto min-w-0">
            {title && (
              <h2
            ...
            <div className="h-1 w-16 sm:w-20 md:w-24 bg-yellow-500 rounded-full mx-auto mt-4 sm:mt-6" />
          </div>
        )}
