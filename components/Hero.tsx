    ...
    <div className="relative sm:min-h-screen flex items-center bg-[#050505] overflow-hidden selection:bg-yellow-500 selection:text-black pt-24 pb-7 sm:pt-16 sm:pb-6 lg:pt-[clamp(5rem,10vw,7.5rem)] lg:pb-[clamp(2rem,5vw,4rem)]">
      ...
      <div className="relative z-10 container w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-8 items-center min-w-0">
        ...
        >
          ...
          >
            You don't need "a developer." You need a{" "}
            <span className="text-white font-bold">revenue machine</span>. I've
            helped clients generate{" "}
            <span className="text-yellow-500 font-bold">$2.4M+</span> in
          ...
          <div className="relative z-10 rounded-xl sm:rounded-2xl h-full overflow-hidden border border-neutral-800 bg-neutral-900 min-w-0">
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4 mb-2 sm:mb-3 min-w-0">
                <div
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-yellow-500 flex items-center justify-center text-black font-bold shrink-0"
                  style={{ fontSize: "var(--text-body)" }}
                >
                  $
                </div>
                <div className="min-w-0">
                  <p
                    className="font-bold text-white leading-none wrap-break-word"
                    style={{ fontSize: "var(--text-body)" }}
                  >
                    ROI or Refund
                  </p>
              ...
              <p className="text-neutral-300 font-medium text-sm sm:text-base wrap-break-word min-w-0">
                "If your app doesn't make you money, you don't pay. Simple."
              </p>
            </div>
          </div>
        </div>
